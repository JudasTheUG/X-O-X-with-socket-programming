...
namespace YazilimSinamaOdev
{
    public partial class PvC : Form
    {
        ...
        private void PvC_Load(object sender, EventArgs e)
        {
            DisableButtons();
        ...
        private void btnComp_Click(object sender, EventArgs e)
        {
            ...
            reflex.suddenReflex(btnKare1, btnKare2, btnKare3, btnKare4, btnKare5, btnKare6, btnKare7, btnKare8, btnKare9);
        }

        private void btnOyun_Click(object sender, EventArgs e)
        {
            EnableGame();
            btnPlayer.PerformClick();
        ...
        private void anyButton_Click(object sender, EventArgs e)
        {
            ...
            {
                DisableButtons();
                MessageBox.Show("Berabere kaldın.Kendini bir daha denemek için yeni oyun başlat! ");
            }
        }

        private void PvC_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        public void lineControl()
        {
            ...
            { DisableButtons(); MessageBox.Show("" + Oyuncu() + " Kazandı !!!"); }
